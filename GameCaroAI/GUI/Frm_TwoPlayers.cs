    ...
    public partial class Frm_TwoPlayers : Form
    {
        ...
        private void Btn_Click(object sender, EventArgs e)
        {
                               ...
                               
            {
                ...
                if (isXTurn)
                {
                    btn.BackgroundImage = Image.FromFile("D:\\Tài liệu học tập\\N3-HK2\\Trí tuệ nhân tạo\\Project\\GameCaroAI\\GameCaroAI\\Assess\\Images\\X.png");
                ...
                {
                    btn.BackgroundImage = Image.FromFile("D:\\Tài liệu học tập\\N3-HK2\\Trí tuệ nhân tạo\\Project\\GameCaroAI\\GameCaroAI\\Assess\\Images\\O.png");
                    btn.BackgroundImageLayout = ImageLayout.Stretch;
                    board[col, row] = "O";
                    oCount++;
